                ...
                <tbody>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td><?php if ($user['User']['logo_href']) : ?>
                            <?php if (!empty($user['User']['logo_href'])) :
                                    echo '<img src="' . h($user['User']['logo_href']) . '" />';
                                endif; ?>&nbsp;
                            <?php endif; ?> </td>
                            <td><?php echo h($user['User']['headline']); ?>&nbsp;</td>
